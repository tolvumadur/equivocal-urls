...
def load_url_bytes():
    ...
    if desc == "testing":
        ...
        url_bytes = b"https://n.pr\xcb\x98aa-ver45.co.uk/a/b.c?a=1&b=3,4#frag"
        url_b64   = "aHR0cHM6Ly9uLnByy5hhYS12ZXI0NS5jby51ay9hL2IuYz9hPTEmYj0zLDQjZnJhZw=="
        #url_b64 = "aHR0cHM6Ly9uLnBy4rCvYWEtdmVyNDUuY28udWsvYS9iLmM/YT0xJmI9Myw0I2ZyYWc="
...
try:
    ...
    if desc == "testing":
        print("URL is:", str(url, encoding="ascii", errors="backslashreplace"))
        print(f"Base64 is {base64.b64encode(url)}")
